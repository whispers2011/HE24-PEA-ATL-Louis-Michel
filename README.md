...
![Schichtenarchitektur: API-, Service- und Daten-Schicht über der SQLite-Datenbank](docs/img/diagramm-architektur.png)
...
![Datenmodell: User besitzt Links, Link erhält Klicks](docs/img/diagramm-datenmodell.png)
